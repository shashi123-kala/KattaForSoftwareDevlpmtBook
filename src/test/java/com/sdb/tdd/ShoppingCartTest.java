...
public class ShoppingCartTest {
	...
	@Test
	public void buyingThreeCpyOfOneBookWithTwoCpysOfOneBookAndThreeCpyofOneBook () {
	...
	public void buyingFourCpysOfTwoDifftBook () {		
		...
		SoftwareDevelopmentBook sdbSecII = Catalog.GivenASoftwareDevelopmentIIBook();
		SoftwareDevelopmentBook sdbSecIII = Catalog.GivenASoftwareDevelopmentIIBook();
		SoftwareDevelopmentBook sdbSecIV = Catalog.GivenASoftwareDevelopmentIIBook();
		...
		shoppingCart.Add(sdbSecII);
		shoppingCart.Add(sdbSecIII);
		shoppingCart.Add(sdbSecIV);
		assertEquals(380.0, shoppingCart.getTotalPrice());

	}
	@Test
	public void buyingOneCpyOfThreDifftBookWithThreeCpysOfOneBookAndTwoCpyofOneBookwithOneCopyOfoneBook () {
		...
		SoftwareDevelopmentBook sdbFourthI = Catalog.GivenASoftwareDevelopmentIVBook();			
		SoftwareDevelopmentBook sdbFourthII = Catalog.GivenASoftwareDevelopmentIVBook();
		SoftwareDevelopmentBook sdbFourthIII = Catalog.GivenASoftwareDevelopmentIVBook();
...
public void buyingFiveCpyOfOneBookWithOneCpyOfThreeDifftBook () {
		...
		shoppingCart.Add(sdbThirdI);
		shoppingCart.Add(sdbFourthI);
		assertEquals(360.0, shoppingCart.getTotalPrice());
